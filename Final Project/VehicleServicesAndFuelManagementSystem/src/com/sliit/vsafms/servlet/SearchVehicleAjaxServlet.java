...
/**
 * Servlet implementation class SearchVehicleAjaxServlet
 */
		...
		try {
			...
			if(vehList.size()!=0) {
				...
				for(Vehicle veh :vehList) {
				  ...
				  PrintWriter writer =response.getWriter();
				  writer.println("<tr>");
				  writer.println("<td class=\"alert alert-danger\" colspan=\"9\" style=\"text-align:center\">"+"Vehicle Not Found"+"</td>");
