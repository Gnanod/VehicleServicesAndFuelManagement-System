 ...
 <%} %>               
    ...
    <div class="main main-raised">
        <div class="container">
            ...
            <h3 class="title" style="margin-left: 20px">Update Price</h3>
            ...
            <table class="table" style="width:90%">
                <thead>
                    <tr>
                        ...
                        <th class="text-center">Current Price (LKR)</th>
                        <th class="text-center">NEW PRICE (LKR)</th>
                    </tr>
                </thead>
                <tbody id="fuelPriceUpdate">
                <% 
                	FuelService fuelServie = new FuelServiceImpl();
            
              	 	ArrayList<Fuel> list = fuelServie.getFuelName();
                ...
                %>
                    ...
                    <tr>                        
                        <td><%=f.getFuleName() %></td>
                        <td class="text-center"><%=f.getPriceUpdateDate() %></td>
                        <td class="text-center"><%=f.getPrice() %></td>                   
                      
                        <td class="td-actions text-right">                        	
                            	<form class="form" method="post" action="UpdateFuelPriceServlet">
                            	<input type="text" id="updateText"name="updatPrice" class="form-control" style="width:70%">
                            	<input type="hidden" id="UpdateFuelPriceInput" name="UpdateFuelPrice" value="<%=f.getFuleName() %>"/>
                            	<button type="submit" class="btn btn-warning" onclick="funtionSetPrice()"
                            	style="margin-top: -50px">UPDATE</button>                            	
                            	</form>
                        </td>                    
                    </tr>
                    <%
	...
	<script>
	function funtionSetPrice(){
	var value = $("#updateText").val();
