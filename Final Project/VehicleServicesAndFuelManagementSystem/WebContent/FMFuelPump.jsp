 ...
 <%} %>               
    ...
    <div class="main main-raised">
        <div class="container">
            ...
            <h3 class="title" style="margin-left: 20px">Fuel Pump</h3>


            <!--  -->

            <div class="row" style="margin-left:45%; margin-top:-80px">
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="title">
                        <h4>Fuel Catagory</h4>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12" style="margin-left:0px;margin-top:10px">
                <form class="form" method="post" action="AddFuelPumpServlet">
                    <select class="selectpicker" data-style="select-with-transition" title="Single Select" name="selFul"
                        data-size="7">
                        <option disabled>Choose Catagory</option>
                        ...
                        <option value="Supper Diesel">Supper Diesel</option>
                        <option value="Kerosene">Kerosene</option>
                    </select>  
                    <button type="submit" class="btn btn-warning" style="width:80px;height:30px;margin-left:250px;margin-top:-60px">ADD</button>                  
                </form>
                </div>
            </div>
            ...
            <table class="table" style="width:100%">
                <thead>
                    <tr>
                        <th class="text-center">Fuel Pump ID</th>
                        <th class="text-center">Fuel ID</th>
                        <th class="text-center">Fuel Name</th>
                    </tr>
                </thead>
                <tbody>
                ...
                <%
                          ...
                          ArrayList<FuelPump> list = fuelPumpService.getAllFuelPump();
				...
				%>
                    <tr>
                        <td class="text-center"><%=p.getFuelPumpId() %></td>
                        <td class="text-center"><%=p.getFuelId() %></td>
                        <td class="text-center"><%=p.getFuelName() %></td>
                        <td class="td-actions">
                        
                        <form action="DeleteFuelPumpServlet" method="post">
                          <input type="hidden" id="DeletePumpInput" name="deleteFuelPump" value="<%=p.getFuelPumpId() %>"/>
