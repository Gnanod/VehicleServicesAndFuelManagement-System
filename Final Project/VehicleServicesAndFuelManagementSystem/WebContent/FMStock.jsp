                    ...
                    <div class="card" style="background-color: rgb(38, 184, 81)">
                        <div class="card-body">
                        	...
                        	<input type="hidden" id="UpdateFuelQty" name="FuelName" value="Petrol Octane 92">
                        	         ...
                        	         <% 
                						FuelService fuelServie1 = new FuelServiceImpl();            
              	 						Double qtyP92 = fuelServie1.getFuelQtyP92();            	 	
                    	             %>                   	  
                    	    
                            <h2 class="card-title"><%=qtyP92 %> &nbsp; Liters</h2>
    ...
    <div class="row" style="margin-left:5px"> -->
                <div class="col-lg-4 col-md-6 col-sm-12" style="margin-left:100px">
                    ...
                    <div class="card" style="background-color: rgb(231, 71, 31)">
                        <div class="card-body">
                        			...
                        			<% 
                						FuelService fuelServie2 = new FuelServiceImpl();            
              	 						Double qtyP95 = fuelServie2.getFuelQtyP95();            	 	
                    	             %> 
                            <h2 class="card-title"><%=qtyP95 %> &nbsp; Liters</h2>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-12" style="margin-left:0px;margin-top:-15px">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    ...
                    <div class="card" style="background-color: rgba(62, 71, 80, 0.61)">
                        <div class="card-body">
                        			...
                        			<% 
                						FuelService fuelServie3 = new FuelServiceImpl();            
              	 						Double qtyDAU = fuelServie3.getFuelQtyDAU();            	 	
                    	             %> 
                            <h2 class="card-title"><%=qtyDAU %> &nbsp; Liters</h2>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-12" style="margin-left:0px;margin-top:-15px">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12" style="margin-left:100px">
                    ...
                    <div class="card" style="background-color: rgba(16, 96, 201, 0.836)">
                        <div class="card-body">
                        			...
                        			<% 
                						FuelService fuelServie4 = new FuelServiceImpl();            
              	 						Double qtyDSU = fuelServie4.getFuelQtyDSU();            	 	
                    	             %> 
                            <h2 class="card-title"><%=qtyDSU %> &nbsp; Liters</h2>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-12" style="margin-left:0px;margin-top:-15px">
            ...
            <div class="row" style="margin-left:5px">
                <div class="col-lg-4 col-md-6 col-sm-12">
                    ...
                    <div class="card" id="kerq" style="background-color:  rgba(247, 14, 14, 0.808)">
                        <div class="card-body">
                        
                        			<% 
                						FuelService fuelServie5 = new FuelServiceImpl();            
              	 						Double qtyKER = fuelServie5.getFuelQtyKER();            	 	
                    	             %> 
                            <h2 class="card-title"><%=qtyKER %> &nbsp; Liters</h2>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-12" style="margin-left:0px;margin-top:-15px">
...
<%
	...
	if(q1 <1500){
		...
		outw.println("<script src='https://cdnjs.cloudflare.com/ajax/libs/limonte-sweetalert2/6.11.4/sweetalert2.all.js'></script>");
		outw.println("<script src='https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js'></script>");
		outw.println("<script>");
		outw.println("$(document).ready(function(){");
		outw.println("swal ( 'Low Volume' ,  'Check the Fuel volumes' ,  'warning' );");
		outw.println("});");
		outw.println("</script>");		
		}
