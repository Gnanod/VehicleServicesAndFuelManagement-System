    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item pad">
                    <a href="addJobShedule.jsp" class="nav-link" >
      ...
      <div class="row">
        <div class="col-md-8 ml-auto mr-auto">
          <div class="brand text-center">
            ...
            <h3 class="title text-center">System</h3>
              ...
              <div class="row">
                  <div class="col-md-5">
                      <div class="card-header card-header-image">
                          <a href="#pablito">
                              <img class="img" src="assets/images/VehicleShedule.jpg">
                          </a>
                      </div>
                  </div>
                  <div class="col-md-7">
                      ...
                      <h3 class="card-title ">
                          <a href="#pablo" class="text-info">Shedule Service</a>
                      </h3>
          ...
          <div class="card card-plain card-blog">
              <div class="row">
                  <div class="col-md-7">
                      ...
                      <h3 class="card-title">
                          <a href="#pablo" class="text-danger">Vehicle Parts</a>
                      </h3>
                  ...
                  <div class="col-md-5">
                      <div class="card-header card-header-image">
                          <img class="img img-raised" src="assets/images/VehicleParts.jpg">
                      </div>
                  </div>
              </div>
          </div>
              ...
              <div class="card card-plain card-blog">
                  <div class="row">
                      <div class="col-md-5">
                          <div class="card-header card-header-image">
                              <a href="#pablito">
                                  <img class="img" src="assets/images/fuelManagement.jpg">
                              </a>
                          </div>
                      </div>
                      <div class="col-md-7">
                          <!--<h6 class="card-category ">Enterprise</h6>-->
                          <h3 class="card-title ">
                              <a href="#pablo" class="text-info">Fuel Management</a>
                          </h3>
                          <p class="card-description">
                              Like so many organizations these days, Autodesk is a company in transition. It was until recently a traditional boxed software company selling licenses. Today, it’s moving to a subscription model. Yet its own business model disruption is only part of the story — and…
                              <a href="#pablo"> Read More </a>
