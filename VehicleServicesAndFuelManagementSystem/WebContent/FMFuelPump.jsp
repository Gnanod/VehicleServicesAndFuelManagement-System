...
<body>
    ...
    <div class="main main-raised">
        <div class="container">
            ...
            <div class="row" style="margin-left:50%; margin-top:-80px">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12" style="margin-left:0px;margin-top:10px">
                    <select class="selectpicker" data-style="select-with-transition" title="Single Select"
                        ...
                        <option value="1">Petrol Octane 92</option>
                        <option value="2">Petrol Octane 95</option>
                        <option value="3">Auto Diesel</option>
                        <option value="4">Supper Diesel</option>
